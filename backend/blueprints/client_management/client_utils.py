...
def build_stream_url(group: Dict[str, Any], stream_id: str, group_name: str, srt_ip: str) -> str:
    """Build SRT stream URL for a client using the provided stream_id directly"""
    ...
    # Use the provided stream_id directly (it should already be the correct database stream ID)
    actual_stream_id = stream_id
    
    # Build the stream path using the actual stream ID
